...
e4e = '/workspace/pretrained_models/e4e_ffhq_encode.pt'
stylegan2_ada_ffhq = '/workspace/pretrained_models/ffhq.pkl'
style_clip_pretrained_mappers = ''
ir_se50 = '/workspace/pretrained_models/model_ir_se50.pth'
dlib = '/workspace/pretrained_models/shape_predictor_68_face_landmarks.dat'
...
input_data_path = 'data/aligned' #align한 dataset
